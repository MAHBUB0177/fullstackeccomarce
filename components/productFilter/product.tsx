  ...
  return (
    <div className="w-full ">
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4   gap-4 ">
        ...
        <>
          {item?.map((item, i) => (
            <div key={i} className="relative mt-2 flex w-full cursor-pointer   flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md" onClick={() => handleOnClick(item?._id)}>
